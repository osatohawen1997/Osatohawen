                    ...
                    <div class="notification-container">
                        ...
                        <form method='POST' enctype='multipart/form-data'>
                            ...
                            <div class='form-group'>
                                ...
                                <small class>Image must not exceed 8MB size and must be jpg, and png format.</small>
                            </div>

                            <div class='form-group'>
                                <label class='form-label' for='tool'>Tools</label>
                                <input type='text' name='tool' class='form-input' autocomplete='off' required>
                            </div>

                            <button type="submit" name="add_graphics" class="btn btn-primary">
                                Add Project
                            </button>
                        </form>
                    </div>
